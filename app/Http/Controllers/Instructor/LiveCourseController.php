...
class LiveCourseController extends Controller {
    public function courses() {
        $courses = Course::orderBy('id', 'desc')->where('instructor_id', auth()->guard('instructor')->user()->id)->where('category_id', 0)->get();

        return view('frontend.instructor.livecourses.index', compact('courses'));
    }
    ...
    public function create() {
        ...
        return view('frontend.instructor.livecourses.create', $data);
    }
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('instructor.livecourses.edit', $course->id)->with('success', 'Your course Added!! Now add schedule');
    }
    ...
    public function edit($id) {
        ...
        return view('frontend.instructor.livecourses.edit', compact('course', 'categories', 'sub', 'child', 'childsub', 'instructors'));
    }
    ...
    public function update(Request $request, $id) {
        ...
        return to_route('instructor.livecourses.index')->with('success', 'Your courses updated successfully!!');
    }
    ...
    public function active(Request $request, $id) {
        ...
        return redirect()->route('instructor.livecourses.index')->with('success', 'Course activated successfully!!');
    }
    ...
    public function inactive(Request $request, $id) {
        ...
        return redirect()->route('instructor.livecourses.index')->with('success', 'Course inactivated successfully!!');
    }
