(function ($) {
    ...
    $(function () {
                ...
                for (var i = 0; i < chart.data.datasets.length; i++) {
                    text.push(
                        '<li><span class="legend-box" style="background:' +
                            ...
                            ';"></span><span class="legend-label" style="">'
                    );
        ...
        if ($("#revenue-for-last-month-chart").length) {
            var lineChartCanvas = $("#revenue-for-last-month-chart")
                .get(0)
                .getContext("2d");
            ...
            document.getElementById("revenuechart-legend").innerHTML =
        ...
        if ($("#serveLoading").length) {
            ...
            document.getElementById("serveLoading-legend").innerHTML =
                saleschart.generateLegend();
        }
        var dataManagedData = {
            labels: [
        ...
        if ($("#dataManaged").length) {
            ...
            document.getElementById("dataManaged-legend").innerHTML =
                saleschart.generateLegend();
        }
        var salesTraficData = {
            labels: [
        ...
        if ($("#salesTrafic").length) {
            ...
            document.getElementById("salesTrafic-legend").innerHTML =
                saleschart.generateLegend();
        }
