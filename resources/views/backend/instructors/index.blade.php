            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('admin.instructors.create') }}" class="btn btn-outline-primary">Add
                                Instructors</a>
                            <br>
                            <br>
                                        ...
                                        <tr>
                                            <td class="d-flex justify-content-between">
                                                ...
                                                @if ($instructor->status === 1)
                                                    <form action="{{ route('admin.instructors.inactive', $instructor) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
                                                ...
                                                @else
                                                    <form action="{{ route('admin.instructors.active', $instructor) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
