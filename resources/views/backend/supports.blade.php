                                ...
                                <tbody>
                                    @foreach ($supports as $support)
                                        <tr>
                                            ...
                                            @if ($support->course)
                                            <td>
                                                <strong>{{ $support->course->name }}</strong> <br>
                                                Instructor: {{ $support->instructor->name }}
                                            </td>
                                            @else
                                            <td>
                                            ...
                                            <td>
                                                @if($support->status)
                                                <a class="badge badge-pill badge-info" disabled>Solved</a>
                                                @else
                                                <a class="badge badge-pill badge-danger" disabled>Not Solved</a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
