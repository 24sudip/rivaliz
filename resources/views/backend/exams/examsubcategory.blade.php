...
@section('title', 'Quiz Sub-Category')
...
@section('backend')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Quiz Sub Category List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Quiz Sub-Category</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('admin.courses.createexamsubcatgeory') }}" class="btn btn-outline-primary">
                                    ...
                                    @foreach ($categories as $category)
                                        <tr>
                                         <td class="d-flex justify-content-between">
                                                   <a href="{{ route('admin.courses.editexamsubcatgeory', $category) }}"
                                                    class="btn btn-info btn-xs"> <i class="fas fa-edit"></i> </a>


                                                     <form action="{{ route('admin.courses.deleteexamsubcatgeory', $category->id) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
