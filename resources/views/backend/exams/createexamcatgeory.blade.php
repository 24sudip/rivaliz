...
@section('title', 'Create Quiz/Exam Category')
...
@section('backend')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Create Quiz/Exam Category</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <!-- /.card-header -->
                        <!-- form start -->
               <form action="{{ route('admin.courses.storeexamcatgeory') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
