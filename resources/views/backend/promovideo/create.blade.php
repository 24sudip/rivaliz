...
@section('title', 'Create New Video Tutorial')
...
@section('backend')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Create New Video Tutorial</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('admin.promovideo.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="link" class="form-control" id="selling"
                                                value="{{ old('link') }}" placeholder="Video link" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="video" class="form-control" rows="4">{{ old('video') }}</textarea>
                                        </div>
                                    </div>
                                </div>
