            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('admin.courses.createfreevideoscategory') }}" class="btn btn-outline-primary">Add Category</a>
                            <br>
                            <br>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <form action="{{ route('admin.courses.deletefreevideoscategory',$category->id) }}"
                                                            method="POST">
                                                            @csrf
