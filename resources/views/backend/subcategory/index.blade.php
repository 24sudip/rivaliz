            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('admin.subcategory.create') }}" class="btn btn-outline-primary">Add
                                Subcategory</a>
                            <br>
                            <br>
                                        ...
                                        <tr>
                                            <td class="d-flex justify-content-between">
                                                ...
                                                @if ($subcategory->status === 1)
                                                    <form action="{{ route('admin.subcategory.inactive', $subcategory) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
                                                ...
                                                @else
                                                    <form action="{{ route('admin.subcategory.active', $subcategory) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
                                            ...
                                            <td><img src="{{ asset($subcategory->image) }}" height="50" width="50">
                                            </td>
