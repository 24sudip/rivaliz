            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <form action="{{ route('admin.liveclass.update', $class->id) }}" method="post"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name"
                                                placeholder="name" value="{{ $class->name }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="link" class="form-control" id="link"
                                                value="{{ $class->link }}" value="{{ old('link') }}" />
                                        </div>
                                    </div>
                                            ...
                                            <select name="course_id" class="form-control" id="course" required>
                                                ...
                                                @foreach ($courses as $course)
                                                    <option value="{{ $course->id }}"
                                                        @if ($course->id == $class->course_id) selected @endif>
                                                        {{ $course->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" name="scheduled_at" class="form-control"
                                                id="scheduled_at" value="{{ $class->scheduled_at }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="duration" class="form-control" id="duration"
                                                value="{{ $class->duration }}" placeholder="Duration" />
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="description" class="form-control" rows="5">{!! $class->description !!}</textarea>
                                </div>
