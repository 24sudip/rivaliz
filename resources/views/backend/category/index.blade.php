...
@section('title', 'Written Category')
...
@section('backend')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Written Category List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Written Category</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                    ...
                                    @foreach ($categories as $category)
                                        <tr>
                                            <td class="d-flex justify-content-between">
                                                ...
                                                <!--    class="btn btn-info btn-xs"> <i class="far fa-trash-alt"></i> </a>-->
