                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Add new event goes here</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('admin.blogs.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="image">Blog thumbnail<span class="text-danger">* <span style="color:black; color: #00000061; font-size: 12px;"> (374w x 264h)</span></span></label>
                                            <input type="file" name="image" class="form-control" id="image"
                                                placeholder="Blog thumbnil image" value="{{ old('image') }}">
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="banner">Blog Banner<span class="text-danger">* <span style="color:black; color: #00000061; font-size: 12px;"> (1880w x 264h)</span></span></span></label>
                                            <input type="file" name="banner" class="form-control" id="banner"
                                                placeholder="Blog thumbnil banner" value="{{ old('banner') }}">
                                        </div>
                                    </div>
