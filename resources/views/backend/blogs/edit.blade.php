            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <form action="{{ route('admin.blogs.update', $event->id) }}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="banner">Blog banner<span class="text-danger">*</span></label>
                                            <input type="file" name="banner" class="form-control" id="banner"
                                                placeholder="Blog thumbnil banner" value="{{ old('banner') }}">
                                        </div>
                                        <img src="{{ asset($event->banner) }}" style="hight:100px;width:200px">
                                    </div>
