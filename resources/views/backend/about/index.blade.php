            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('admin.courses.aboutcreate') }}" class="btn btn-outline-primary">Add About</a>
                            <br>
                            <br>
                            <table id="example1" class="table table-bordered table-striped">
                             ...
                             <tbody>
                                    @foreach ($datas as $index => $data)
                                          ...
                                          @if ($category->status === 1)
                                           ...
                                           <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <form action="{{ route('admin.courses.aboutdelete', $data->id) }}"
                                                            method="POST">
                                                            @csrf
                                     ...
                                     <td><img src="{{ asset($data->image) }}" height="50" width="50"></td> 
