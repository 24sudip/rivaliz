            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('admin.childcategory.create') }}" class="btn btn-outline-primary">Add Childcategory</a>
                            <br>
                            <br>
                                        ...
                                        <tr>
                                            <td class="d-flex justify-content-between">
                                                ...
                                                @if ($childcategory->status === 1)
                                                    <form action="{{ route('admin.childcategory.inactive', $childcategory) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
                                                ...
                                                @else
                                                    <form action="{{ route('admin.childcategory.active', $childcategory) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
