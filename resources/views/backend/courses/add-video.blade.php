                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Add video for <b>{{ $course->name }}</b></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('admin.courses.storeVideo', $id) }}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="card card-success">
                                    <div class="card-header">
                                        <h3 class="card-title">Video and link<span class="text-danger">*</span>
                                        </h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="increment">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="link[]" class="myfrm form-control"
                                                        placeholder="Video link" required>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="duration[]" class="myfrm form-control"
