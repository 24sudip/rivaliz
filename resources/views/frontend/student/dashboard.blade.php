    ...
    <div class="container-fluid page-body-wrapper">
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-sm-5 flex-column d-flex stretch-card">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-auto grid-margin stretch-card">
                                <div class="card hh">
                                    <div class="card-body pb-0">
                                        <div class="d-flex align-items-center justify-content-between hhh">
                                            <h2 class="text-danger font-weight-bold quicktech-t">{{ $liveClassCount }}</h2>
                                            <i class="fa-solid fa-rotate-right iconn"></i>
                                        </div>
                                    </div>
                                   
                                    <div class="line-chart-row-title">👥 Live Classes</div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 mt-auto grid-margin stretch-card">
                                <div class="card hh">
                                    <div class="card-body pb-0">
                                        <div class="d-flex align-items-center justify-content-between hhh">
                                            <h2 class="text-danger font-weight-bold quicktech-t">{{ number_format($moduleCompleteAvg) }} %</h2>
                                            <i class="fa-solid fa-rotate-right iconn"></i>
                                        </div>
                                    </div>
                                  
                                    <div class="line-chart-row-title">📊 Class Participent Rate </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 mt-auto grid-margin stretch-card">
                                <div class="card hh">
                                    <div class="card-body pb-0">
                                        <div class="d-flex align-items-center justify-content-between hhh">
                                            <h2 class="text-info font-weight-bold quicktech-t">{{ $quizCount }}</h2>
                                           <i class="fa-solid fa-file-lines iconn"></i>
                                        </div>
                                    </div>
                                  
                                    <div class="line-chart-row-title">❓ Your Practiced Quizzes </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 grid-margin stretch-card">
                                <div class="card hh">
                                    <div class="card-body pb-0">
                                        <div class="d-flex align-items-center justify-content-between hhh">
                                            <h2 class="text-warning font-weight-bold quicktech-t">{{ $quizSubmitAvg }}%</h2>
                                           <i class="fa-solid fa-folder iconn"></i>
                                        </div>
                                    </div>
                                   
                                    <div class="line-chart-row-title">✅ Correct answer rates </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 grid-margin stretch-card">
                                <div class="card hh">
                                    <div class="card-body pb-0">
                                        <div class="d-flex align-items-center justify-content-between hh">
                                            <h2 class="text-warning font-weight-bold quicktech-t">0/0</h2>
                                           <i style="color:#2B70B7;" class="fa-solid fa-folder iconn"></i>
                                        </div>
                                    </div>
                                    <div class="line-chart-row-title">📝 Assignments </div>
                                </div>
                            </div>
                            <div class="col-lg-6 grid-margin stretch-card">
                                <a href="{{ route('student.courses') }}" style="width: 100%;">
                                    <div class="card hh">
                                        <div class="card-body pb-0">
                                            <div class="d-flex align-items-center justify-content-between hh">
                                                <h2 class="text-warning font-weight-bold quicktech-t">{{ $courses->count() }}</h2>
                                               <i style="color:#2B70B7;" class="fa-solid fa-folder iconn"></i>
                                            </div>
                                        </div>
                                        <div class="line-chart-row-title">📝 My Courses </div>
                                    </div>
                                </a>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            {{-- <div class="col-lg-4">
                                                <div class="position-relative">
                                                    ...
                                                    <div class="live-info badge badge-success">Student</div>
                                                </div>
                                            </div> --}}
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="text-white px-4 py-4 card" style="background-color: #356FAF;">
                                                    <div class="row">
                                                        <div class="col-sm-6 pl-lg-5 fw-bold">
                                                            <h2>{{ $courses->count() }}</h2>
                                                            <p class="mb-0">Your Enrolled</p>
                                                        </div>
                                                        <div class="col-sm-6 climate-info-border mt-lg-0 mt-2 fw-bold">
                                                            <h2>{{ $instructors->count() }}</h2>
                                                            <p class="mb-0">Your Instructors</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 d-flex grid-margin stretch-card">
                                                <div class="card sale-diffrence-border">
                                                    <div class="card-body overflow-hidden" style="height: 140px">
                                                        <div class="float-end">
                                                            <small class="text-nowrap">{{ $notice->created_at->diffForhumans() }}</small>
                                                        </div>
                                                        <h4 class="card-title mb-2">{{ $notice->title }}</h4>
                                                        <small class="text-muted">{!! $notice->description !!}</small>
                                                    </div>
                                                    
                                                   
                                                    <button type="button" class="btn btn-inverse-dark" data-bs-toggle="modal" data-bs-target="#noticeModal{{ $notice->id }}">
                                                      View Details
                                                    </button>
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="noticeModal{{ $notice->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="row mb-5 gapp">
            <div class="col-md-3 text-center quicktech-pro-dflex">
              <div class="quicktech-profile">
                <img
                  src="../../../assets/frontend/images/profile.avif"
