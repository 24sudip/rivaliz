                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <img src="{{ asset($ebook->photo) }}" class="w-100 course-image" alt="">
                                </div>
                                <div class="col-8 quicktech-main">
                ...
                <!-- <div class="progress">-->
                                            ...
                                            <div class="media mt-4 d-none d-md-block">
                                                ...
                                                <div class="media-body quicktech-width">
                                                    <p class="card-text quicktech-textt">{!! $ebook->description !!}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="quicktech-button mt-2 d-md-block">
                                    <a class="quikctech-entroll" href="{{ route('ebookviews', $ebook->id) }}">View Now</a>
                                   </div>
                                </div>
                            </div>
