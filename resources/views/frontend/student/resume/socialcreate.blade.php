            ...
            <div class="content-wrapper container">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card" style="background-color: #FFF;">
                        <div class="container">
                            <h1 class="p-3 mb-3 border-bottom border-secondary">Add Social Account</h1>

                            <form class="form-horizontal" role="form" action="{{ route('student.socialstore') }}"
