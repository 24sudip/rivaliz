            ...
            <div class="content-wrapper container">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card" style="background-color: #FFF;">
                        <div class="container">
                            <h1 class="p-3 mb-3 border-bottom border-secondary">Edit Skill</h1>

                            <form class="form-horizontal" role="form" action="{{ route('student.skillupdate') }}"
                                method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row justify-content-center">

                                    <input type="hidden" name="hidden_id" value="{{ $skill->id }}">
                                    <!-- edit form column -->
                                    <div class="col-md-6 personal-info">

                                        <h3>Skill info
                                            <a href="{{ route('student.skilldelete', $skill->id) }}"
